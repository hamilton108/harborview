...
var _user$project$Maunaloa_Options_Types$PurchaseStatus = F2(
	function (a, b) {
		return {ok: a, msg: b};
	});
										...
										return function (k) {
											return function (l) {
												return function (m) {
													return function (n) {
														return function (o) {
															return {tickers: a, selectedTicker: b, stock: c, options: d, risc: e, flags: f, tableState: g, dlgPurchase: h, dlgAlert: i, selectedPurchase: j, isRealTimePurchase: k, ask: l, bid: m, volume: n, spot: o};
														};
													};
												};
											};
...
var _user$project$Maunaloa_Options_Commands$buildOption = F8(
	function (t, x, d, b, s, ib, is, be) {
		return _user$project$Maunaloa_Options_Types$Option(t)(x)(d)(b)(s)(ib)(is)(be)(
...
var _user$project$Maunaloa_Options_Commands$calcRisc = F2(
	function (riscStr, options) {
		...
		var risc = A2(
			...
			0,
			_elm_lang$core$String$toFloat(riscStr));
		var jbody = _user$project$Common_Miscellaneous$asHttpBody(
			A2(
				_elm_lang$core$List$map,
				function (x) {
					return {
						ctor: '_Tuple2',
						_0: x.ticker,
						_1: _elm_lang$core$Json_Encode$float(risc)
					};
				},
				checked));
		return A2(
		...
		return A2(
			...
			function (_p4) {
				return _user$project$Maunaloa_Options_Types$OptionMsgFor(
					_user$project$Maunaloa_Options_Types$OptionsFetched(_p4));
			},
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: A2(
							_evancz$elm_sortable_table$Table$floatColumn,
							'Exercise',
							function (_) {
								return _.x;
							}),
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(stockInfo),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						...
						_user$project$Maunaloa_Options_Types$PurchaseMsgFor(_user$project$Maunaloa_Options_Types$PurchaseDlgCancel),
						{
							...
							_0: A2(
								...
								},
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text('Real-time purchase'),
										_1: {ctor: '[]'}
									}
								}),
							_1: {
...
var _user$project$Maunaloa_Options_Main$main = _elm_lang$html$Html$programWithFlags(
	...
	A2(
		...
		A2(_elm_lang$core$Json_Decode$field, 'isCalls', _elm_lang$core$Json_Decode$bool)));
